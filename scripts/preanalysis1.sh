...
${remove_outgroup} ${name}_oneline_fullseq_ns_${date}.fasta ${scriptdir}/../config/outgroups.txt ${name}_oneline_fullseq_ns_NOOUTGROUP_${date}.fasta covid_outgroups.fasta
