...
class Paths():
  ...
  def __init__( self, argv, i=1 ):
    ...
    self.leaves_thinning_tree = util.versioned_path(version, self.leaves_thinning_tree)
  ...
  leaves_thinning_tree = os.path.join(thinning_dir, "leaves_thinning_tree.newick")
